    ...
    <div id="interface">
        <section>
            <div>
                ...
                <div id="container">
                    <img src="../imagens/academia%20xtreme.jpg" id="imagemBackgroud" alt="Background">
            ...
            <div id="Avaliacoes_Clientes">
                ...
                <section class="cards">
                    <div class="card">
                        ...
                        <p class="card_text">
                            Essa academia é top demais, mano! Os equipamentos são de alta qualidade mesmo. Dá
                            pra ver que tão sempre em dia, bem cuidados e tudo mais. Tem uma variedade incrivel de
                            equipamentos, sem ela não seria vice, tamaluko.
                        </p>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <p class="card_text">
                            Essa academia é simplesmente incrível! Os equipamentos são de primeira linha e oferecem uma
                            experiência de treino excepcional. A variedade de opções disponíveis atende a todos os tipos
                            de exercícios e níveis de condicionamento físico.Por enquanto sou apenas o junior mas logo
                            logo pai vai ta como
                        </p>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        <img class="image_card"
                             src="https://www.greatestphysiques.com/wp-content/uploads/2019/04/Renato-Cariani.06.jpg">
                        <h3>Renato Cariri</h3>
                        <div class="stars">
                            <img src="../telaAvaliacoes/estrela%20(2).png">
                            <img src="../telaAvaliacoes/estrela%20(2).png">
            ...
            <div id="Fale conosco">
                ...
                <div id="myModal" class="modal">
                    <div class="modal-content">
                        ...
                        <img id="modalImage" src="" alt="" style="width:100px;height:100px;">
                        <p id="modalText"></p>
                    </div>
                </div>
                ...
                <script>
                    ...
                    function validarFormulario() {
                        ...
                        if (nome == "" || email == "" || telefone == "" || mensagem == "") {
                            document.getElementById("modalText").innerHTML = "Por favor, preencha todos os campos.";
                            document.getElementById("modalImage").src = "https://i.pinimg.com/474x/bf/68/3d/bf683da73f36d4739b2815cca83a1830.jpg";
                            modal.style.display = "block";
                        } else if (!emailRegex.test(email)) {
                            document.getElementById("modalText").innerHTML = "Por favor, insira um email válido.";
                            document.getElementById("modalImage").src = "https://i.pinimg.com/474x/bf/68/3d/bf683da73f36d4739b2815cca83a1830.jpg";
                            modal.style.display = "block";
                        } else if (!telefoneRegex.test(telefone)) {
                            document.getElementById("modalText").innerHTML = "Por favor, insira um número de telefone no formato (11) 95454-9090.";
                            document.getElementById("modalImage").src = "https://i.pinimg.com/474x/bf/68/3d/bf683da73f36d4739b2815cca83a1830.jpg";
                            modal.style.display = "block";
                        } else {
                            document.getElementById("modalText").innerHTML = "Mensagem enviada com sucesso!";
                            document.getElementById("modalImage").src = "https://i.pinimg.com/originals/88/b8/ee/88b8ee71ed5b22ee49ebfc36dfde4fd9.gif";
                            modal.style.display = "block";
                    ...
                    <div id="Social">
                        ...
                        <div class="social-icons">
                            ...
                            <a class="social-icon social-icon--twitter" href="https://twitter.com/Corinthians">
